...
class _ShimmerLoadingState extends ConsumerState<ShimmerLoading> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Animate from -1 to 2 to ensure the sweeping highlight completely enters and exits the screen
...
class _SlidingGradientTransform extends GradientTransform {
  ...
  Matrix4? transform(Rect bounds, {TextDirection? textDirection}) {
    // We translate the gradient across the width of the container
