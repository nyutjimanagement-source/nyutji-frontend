              ...
              : _mitras.isEmpty 
                ? Center(
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Icon(LucideIcons.motorbike, size: 40, color: Colors.grey[200]),
                          const SizedBox(height: 12),
                          Text("Belum ada Mitra Laundry di wilayah Anda\nSilakan ubah lokasi penjemputan atau Manfaatkan layanan Search", 
